...
export default function First() {
  return (
    <div className="w-[350px] md:w-[732px] lg:w-[1000px] mt-[70px] rounded-3xl text-white flex flex-col justify-center lg:justify-normal lg:items-center items-end h-[600px] lg:h-[915px] bg-hero-pattern bg-center bg-no-repeat">
